...
public class mbdb {
    ...
    public ArrayList<String> finder_unstable(String path,String name,String field_name,String clstr) throws IOException{
        int op = 0;
        String row;
        BufferedReader reader = new BufferedReader(new FileReader(path));
    ...
    public ArrayList<ArrayList<String>> Selecter(String path,String[] attr,String[] feild_name,String[] what) throws IOException{
